  ...
  head: () => ({
    meta: [
      { title: "Блiнцы — блинная на Октябрьской в Минске" },
      {
        name: "description",
        content:
          "Блiнцы на Октябрьской, 23 в Минске. Большие блины с сытными и сладкими начинками, меню, часы работы и контакты.",
      },
      { property: "og:title", content: "Блiнцы — блинная на Октябрьской" },
      {
        property: "og:description",
        content: "Большие блины с десятками начинок в самом сердце Октябрьской улицы.",
      },
    ...
    <div className="overflow-x-hidden">
          ...
          <div className="relative mx-auto w-full max-w-6xl px-5 pt-32 pb-14 text-cream sm:pb-20">
            <Reveal>
              ...
              <p className="mt-6 max-w-lg text-base leading-relaxed text-cream/80">
                Большие тонкие блины на сковородке, щедрые начинки и десятки сочетаний — от сытной
                классики с курицей и грибами до сладких вариантов с фруктами и сгущёнкой.
              </p>
          ...
          <div className="grid gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <Reveal>
              ...
              <p className="mt-6 text-sm leading-relaxed text-muted-foreground sm:text-base">
                Здесь тонкое тесто на сковородке становится полноценным обедом. Курица, бекон,
                грибы, сыры, овощи и яркие соусы собираются в большие сытные блины. Есть варианты на
                шпинатном тесте, сладкие блины с ягодами и сгущёнкой, кофе и лимонады.
              </p>
              <div className="mt-9 border-l-2 border-accent pl-5 text-sm leading-relaxed">
                <strong>Формат простой:</strong> выбрать начинку, взять горячий блин и остаться в
                зале или продолжить прогулку по Октябрьской.
              </div>
            </Reveal>
            <div className="grid grid-cols-2 gap-4">
              <Reveal className="hover-zoom col-span-2" delay={80}>
                <img
                  src={foodUrl}
                  alt="Блин с начинкой в Блiнцах"
                  loading="lazy"
                  width={1200}
                  height={800}
              ...
              <Reveal className="hover-zoom" delay={150}>
                <img
                  src={sweetPancake}
                  alt="Сладкий блин с фруктовой начинкой"
                  loading="lazy"
                  width={1200}
                  height={800}
              ...
              <Reveal className="hover-zoom" delay={220}>
                <img
                  src={interiorUrl}
                  alt="Интерьер кафе Блiнцы на Октябрьской"
                  loading="lazy"
                  width={1200}
                  height={800}
                  className="h-48 w-full object-cover sm:h-60"
          ...
          <div className="mx-auto max-w-6xl px-5">
            <Reveal className="max-w-2xl">
              ...
              <p className="mt-5 text-sm leading-relaxed text-cream/60">
                Показываем популярные позиции из меню. Актуальные цены и наличие уточняйте в кафе —
                блiнцы печут на сковородке прямо при заказе.
              </p>
            </Reveal>
            <div className="mt-10 flex flex-wrap gap-2">
              {(
                [
                  ["savory", "Сытные"],
                  ["spinach", "Шпинатное тесто"],
                  ["sweet", "Сладкие и сырники"],
                  ["drinks", "Напитки"],
                ] as [Tab, string][]
              ).map(([key, label]) => (
                <button
                  ...
                  className={`border px-5 py-2.5 text-[0.7rem] tracking-[0.16em] uppercase transition ${tab === key ? "border-accent bg-accent text-accent-foreground" : "border-cream/25 text-cream/70 hover:text-cream"}`}
                >
                  {label}
                </button>
              ))}
            ...
            <div key={tab} className="animate-in fade-in slide-in-from-bottom-4 mt-8 duration-700">
              {tab === "savory" ? (
                <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
                  <MenuBlock section={savoryPancakes} dark />
                  <img
                    src={foodUrl}
                    alt="Большой блин с сытной начинкой"
                    loading="lazy"
              ...
              {tab === "spinach" ? (
                <div className="grid gap-6 lg:grid-cols-2">
                  <MenuBlock section={spinachPancakes} dark />
                  <MenuBlock section={fishPancakes} dark />
                </div>
              ) : null}
              {tab === "sweet" ? (
                <div className="grid gap-6 lg:grid-cols-2">
                  <MenuBlock section={sweetPancakes} dark />
                  <div className="space-y-6">
                    <MenuBlock section={syrniki} dark />
                    <MenuBlock section={soups} dark />
                  </div>
                </div>
              ) : null}
              {tab === "drinks" ? (
                <div className="grid gap-6 lg:grid-cols-3">
                  ...
                  <MenuBlock section={houseDrinks} dark />
                  <MenuBlock section={drinks} dark />
                </div>
              ) : null}
            </div>
          </div>
        ...
        <section id="place" className="mx-auto max-w-6xl px-5 py-24 sm:py-32">
          <div className="grid gap-10 lg:grid-cols-2 lg:items-end">
            <Reveal>
              ...
              <h2 className="mt-5 text-4xl leading-[1.05] sm:text-6xl">
                Городской ритм снаружи. Горячий блин внутри.
              </h2>
              <p className="mt-6 text-sm leading-relaxed text-muted-foreground sm:text-base">
                «Блiнцы» находятся на Октябрьской улице — в индустриальном квартале со стрит-артом.
                Внутри — лаконичный зал с деревом и графикой, пахнет горячими блинами и кофе. В
                тёплый сезон работает посадка на улице.
              </p>
            </Reveal>
            <Reveal className="hover-zoom" delay={100}>
              <img
                src={interiorUrl}
                alt="Зал кафе Блiнцы"
                loading="lazy"
                width={1200}
                height={800}
                className="h-80 w-full object-cover sm:h-[30rem]"
              />
            </Reveal>
          </div>
        </section>
        ...
        <section id="visit" className="surface-dark py-24 sm:py-32">
          <div className="mx-auto grid max-w-6xl gap-12 px-5 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            <Reveal>
              ...
              <h2 className="mt-5 max-w-2xl text-5xl leading-[0.98] sm:text-7xl">
      ...
      <footer className="border-t border-border bg-background py-10">
        <div className="mx-auto flex max-w-6xl flex-col gap-4 px-5 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          <p className="font-display text-2xl uppercase text-foreground">Блiнцы</p>
